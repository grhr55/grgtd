...
<div className=' min-[1900px]:mx-[14%] max-[1700px]:mx-[8%]' >
  <h1 className='text-amber-50 font-extrabold text-[60px] '>News</h1>
  ...
  <span className="text-amber-50 text-[20px] font-medium">news</span>
</nav>
  ...
  <div className=''>
   ...
   {currentProducts.map(product => (
    <Link
      key={product._id}
      href={`/news/${slugify(product.namenews)}`}
